      ...
      <div>
        <Link to={`/products/${product._id}`}>
          ...
          <div className="p-4">
            ...
            <h3 className="font-semibold text-lg mt-1 h-12 overflow-hidden">
        ...
        <button
          className={`mt-4 w-full bg-green-600 hover:bg-green-700  text-white   py-2 px-4 rounded-md font-semibold  transition duration-300`}
